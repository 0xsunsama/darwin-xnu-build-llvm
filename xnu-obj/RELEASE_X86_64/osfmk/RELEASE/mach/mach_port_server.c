...
mig_internal kern_return_t __MIG_check__Request__mach_port_is_connection_for_service_t(__attribute__((__unused__)) __Request__mach_port_is_connection_for_service_t *In0P)
{
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_port_is_connection_for_service_t__defined)
	check_result = __MIG_check__Request__mach_port_is_connection_for_service_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_port_is_connection_for_service_t__defined) */
	...
	OutP->RetCode = mach_port_is_connection_for_service(task, In0P->connection_port, In0P->service_port, &OutP->filter_policy_id);
	space_deallocate(task);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
...
mig_internal kern_return_t __MIG_check__Request__mach_port_get_service_port_info_t(__attribute__((__unused__)) __Request__mach_port_get_service_port_info_t *In0P)
{
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_port_get_service_port_info_t__defined)
	check_result = __MIG_check__Request__mach_port_get_service_port_info_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_port_get_service_port_info_t__defined) */
	...
	OutP->RetCode = mach_port_get_service_port_info(task, In0P->name, &OutP->sp_info_out);
...
mig_internal kern_return_t __MIG_check__Request__mach_port_assert_attributes_t(__attribute__((__unused__)) __Request__mach_port_assert_attributes_t *In0P)
{
	...
	if (In0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Request__mach_port_assert_attributes_t__infoCnt(&In0P->infoCnt, In0P->NDR.int_rep);
#endif	/* __NDR_convert__int_rep__Request__mach_port_assert_attributes_t__infoCnt__defined */
#if	__MigTypeCheck
	if ( In0P->infoCnt > 17 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 68)) / 4 < In0P->infoCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Request) - 68) + (4 * In0P->infoCnt)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_port_assert_attributes_t__defined)
	check_result = __MIG_check__Request__mach_port_assert_attributes_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_port_assert_attributes_t__defined) */
	...
	OutP->RetCode = mach_port_assert_attributes(task, In0P->name, In0P->flavor, In0P->info, In0P->infoCnt);
	space_deallocate(task);
#if	__MigKernelSpecificCode
#endif /* __MigKernelSpecificCode */
...
const struct mach_port_subsystem mach_port_subsystem = {
	...
	(vm_address_t)0,
	{
		...
		{0, 0, 0, 0, 0, 0},
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_port_is_connection_for_service, 4, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_port_is_connection_for_service_t)},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_port_get_service_port_info, 3, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_port_get_service_port_info_t)},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_port_assert_attributes, 5, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_port_assert_attributes_t)},
	}
};
