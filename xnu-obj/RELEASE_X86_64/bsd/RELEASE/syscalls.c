...
const char *syscallnames[] = {
	...
	"sync",               /* 36 = sync */
	"kill",               /* 37 = kill */
	"crossarch_trap",     /* 38 = crossarch_trap */
	"getppid",            /* 39 = getppid */
	"#40",                /* 40 = old lstat */
	"dup",                /* 41 = dup */
	"pipe",               /* 42 = pipe */
	...
	"panic_with_data",    /* 185 = panic_with_data */
	...
	"openat_dprotected_np",  /* 218 = openat_dprotected_np */
	"#219",               /* 219 = old fstatv */
	...
	"#438",               /* 438 = old shared_region_map_and_slide_np */
...
#endif /* NECP */
#if SKYWALK
	"__nexus_open",       /* 503 = __nexus_open */
	"__nexus_register",   /* 504 = __nexus_register */
	"__nexus_deregister",  /* 505 = __nexus_deregister */
	"__nexus_create",     /* 506 = __nexus_create */
	"__nexus_destroy",    /* 507 = __nexus_destroy */
	"__nexus_get_opt",    /* 508 = __nexus_get_opt */
	"__nexus_set_opt",    /* 509 = __nexus_set_opt */
	"__channel_open",     /* 510 = __channel_open */
	"__channel_get_info",  /* 511 = __channel_get_info */
	"__channel_sync",     /* 512 = __channel_sync */
	"__channel_get_opt",  /* 513 = __channel_get_opt */
	"__channel_set_opt",  /* 514 = __channel_set_opt */
#else
	"#503",               /* 503 = */
	"#504",               /* 504 = */
	"#505",               /* 505 = */
...
#if SOCKETS
	"tracker_action",     /* 546 = tracker_action */
#else
	"#546",               /* 546 = */
#endif /* SOCKETS */
	"debug_syscall_reject",  /* 547 = debug_syscall_reject */
	"debug_syscall_reject_config",  /* 548 = debug_syscall_reject_config */
	"graftdmg",           /* 549 = graftdmg */
	"map_with_linking_np",  /* 550 = map_with_linking_np */
	"freadlink",          /* 551 = freadlink */
	"record_system_event",  /* 552 = record_system_event */
	"mkfifoat",           /* 553 = mkfifoat */
	"mknodat",            /* 554 = mknodat */
	"ungraftdmg",         /* 555 = ungraftdmg */
};
