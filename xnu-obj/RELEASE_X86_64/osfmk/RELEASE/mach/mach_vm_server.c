...
mig_internal kern_return_t __MIG_check__Request__mach_vm_purgable_control_external_t(__attribute__((__unused__)) __Request__mach_vm_purgable_control_external_t *In0P)
{
...
#if	defined(__MIG_check__Request__mach_vm_purgable_control_external_t__defined)
	check_result = __MIG_check__Request__mach_vm_purgable_control_external_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_vm_purgable_control_external_t__defined) */

	OutP->RetCode = mach_vm_purgable_control_external(In0P->Head.msgh_request_port, In0P->address, In0P->control, &In0P->state);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
#if	__MigKernelSpecificCode
...
mig_internal kern_return_t __MIG_check__Request__mach_vm_deferred_reclamation_buffer_init_t(__attribute__((__unused__)) __Request__mach_vm_deferred_reclamation_buffer_init_t *In0P)
{
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_vm_deferred_reclamation_buffer_init_t__defined)
	check_result = __MIG_check__Request__mach_vm_deferred_reclamation_buffer_init_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_vm_deferred_reclamation_buffer_init_t__defined) */
	...
	OutP->RetCode = mach_vm_deferred_reclamation_buffer_init(target_task, In0P->address, In0P->size);
...
mig_internal kern_return_t __MIG_check__Request__mach_vm_deferred_reclamation_buffer_synchronize_t(__attribute__((__unused__)) __Request__mach_vm_deferred_reclamation_buffer_synchronize_t *In0P)
{
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_vm_deferred_reclamation_buffer_synchronize_t__defined)
	check_result = __MIG_check__Request__mach_vm_deferred_reclamation_buffer_synchronize_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_vm_deferred_reclamation_buffer_synchronize_t__defined) */
	...
	OutP->RetCode = mach_vm_deferred_reclamation_buffer_synchronize(target_task, In0P->num_entries_to_reclaim);
	task_deallocate_mig(target_task);
#if	__MigKernelSpecificCode
#endif /* __MigKernelSpecificCode */
...
mig_internal kern_return_t __MIG_check__Request__mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes_t(__attribute__((__unused__)) __Request__mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes_t *In0P)
{
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes_t__defined)
	check_result = __MIG_check__Request__mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes_t__defined) */
	...
	OutP->RetCode = mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes(target_task, In0P->reclaimable_bytes);
	task_deallocate_mig(target_task);
#if	__MigKernelSpecificCode
#endif /* __MigKernelSpecificCode */
...
mig_internal kern_return_t __MIG_check__Request__mach_vm_range_create_t(__attribute__((__unused__)) __Request__mach_vm_range_create_t *In0P)
{
	...
	if (In0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Request__mach_vm_range_create_t__recipesCnt(&In0P->recipesCnt, In0P->NDR.int_rep);
#endif	/* __NDR_convert__int_rep__Request__mach_vm_range_create_t__recipesCnt__defined */
#if	__MigTypeCheck
	if ( In0P->recipesCnt > 1024 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 1024)) < In0P->recipesCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Request) - 1024) + _WALIGN_(In0P->recipesCnt)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
...
#pragma pack(pop)
...
#if	defined(__MIG_check__Request__mach_vm_range_create_t__defined)
	check_result = __MIG_check__Request__mach_vm_range_create_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_vm_range_create_t__defined) */
	...
	OutP->RetCode = mach_vm_range_create(target_task, In0P->flavor, In0P->recipes, In0P->recipesCnt);
	vm_map_deallocate(target_task);
#if	__MigKernelSpecificCode
#endif /* __MigKernelSpecificCode */
...
const struct mach_vm_subsystem mach_vm_subsystem = {
	...
	(vm_address_t)0,
	{
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_purgable_control_external, 5, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_purgable_control_external_t)},
          { (mig_impl_routine_t) 0,
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_deferred_reclamation_buffer_init, 5, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_deferred_reclamation_buffer_init_t)},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_deferred_reclamation_buffer_synchronize, 3, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_deferred_reclamation_buffer_synchronize_t)},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_deferred_reclamation_buffer_update_reclaimable_bytes, 3, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_deferred_reclamation_buffer_update_reclaimable_bytes_t)},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_vm_range_create, 4, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_vm_range_create_t)},
	}
};
